About django-treenode-feedstock
===============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-treenode-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-treenode-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-treenode
# for installing globally
pixi global install django-treenode
```
...
It is possible to list all of the versions of `django-treenode` available on your platform:
...
```
pixi search django-treenode --channel conda-forge
```
